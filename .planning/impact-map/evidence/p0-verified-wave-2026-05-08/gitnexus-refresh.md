...
| `stageBundledPluginRuntimeDeps` | `scripts/stage-bundled-plugin-runtime-deps.mjs` | LOW risk; 3 impacted symbols; runtime postbuild and targeted test imports included.                                                                |

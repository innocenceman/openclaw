# iOS Root, Chat, and Canvas Code Paths

Coverage: `exceptioned-deep-partial`

| Path | Trace start | Validation risk |
| --- | --- | --- |
| Owned iOS path | `Root*.swift`, `HomeToolbar.swift`, `NodeAppModel*`, `ShareToAgentDeepLink*` | Gateway trust/session state, SwiftUI behavior, extension/device permission behavior, signing, or generated project drift. |

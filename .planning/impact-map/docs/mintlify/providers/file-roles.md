...
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------ | -------------- | --------------------------------------------------------------------------------------------------------- |
| docs/providers/\*\*                                                     | Primary docs pages owned by this leaf.                                         | deep-partial   | Page moves and filename changes primarily affect docs navigation, root-relative links, and locale parity. |

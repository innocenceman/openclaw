...
Leaf module for `docs/platforms/**` within the Mintlify docs surface.

## Observed facts

26 files and 26 Markdown pages are present under `docs/platforms/`.
An `docs/platforms/index.md` page is present and acts as the local entrypoint.
Sample files:
...
- Changed paths in this leaf: `26` (修改 26).

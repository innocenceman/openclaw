# Docs start Change-to-Test Matrix
...
- Changed paths: `14` (修改 14).
- Target-existing path refs in active map: `14`; deleted/renamed-away refs kept only in transition artifacts: `0`.

...
Leaf module for `docs/web/**` within the Mintlify docs surface.

## Observed facts

5 files and 5 Markdown pages are present under `docs/web/`.
An `docs/web/index.md` page is present and acts as the local entrypoint.
Sample files:

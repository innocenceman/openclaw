...
Leaf module for `docs/diagnostics/**` within the Mintlify docs surface.

## Observed facts

1 files and 1 Markdown page are present under `docs/diagnostics/`.
No `docs/diagnostics/index.md` page was observed; route ownership is spread across leaf pages.
Sample files:

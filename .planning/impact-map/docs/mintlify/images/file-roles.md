...
| ---------------- | ------------------------------------------------------------- | -------------- | ---------------------------------------------------------------------------------------- |
| docs/images/\*\* | Static images and supporting assets referenced by docs pages. | partial        | Path changes surface first as broken links, stale screenshots, or missing illustrations. |
| docs/\*_/_.md\*  | Consuming docs pages that embed or link to these assets.      | partial        | Update references in the same change when an asset path or filename changes.             |

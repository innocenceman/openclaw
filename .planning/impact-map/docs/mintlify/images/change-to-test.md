# Docs images Change-to-Test Matrix
...
- Changed paths: `7` (新增 1，删除 6).
- Target-existing path refs in active map: `1`; deleted/renamed-away refs kept only in transition artifacts: `6`.

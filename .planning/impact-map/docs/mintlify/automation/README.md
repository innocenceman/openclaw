...
Leaf module for `docs/automation/**` within the Mintlify docs surface.

## Observed facts

9 files and 9 Markdown pages are present under `docs/automation/`.
No `docs/automation/index.md` page was observed; route ownership is spread across leaf pages.
Sample files:
...
- Changed paths in this leaf: `13` (修改 9，新增 4).

...
Leaf module for the checked-in Plugin SDK API baseline artifacts in `docs/.generated/plugin-sdk-api-baseline.json*` plus the generator/check path that owns them.

## Observed facts

- `docs/.generated/plugin-sdk-api-baseline.json` and `docs/.generated/plugin-sdk-api-baseline.jsonl` are present as checked-in artifacts.

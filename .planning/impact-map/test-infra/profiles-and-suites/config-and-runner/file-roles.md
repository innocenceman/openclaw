# Test Config and Runner File Roles
...
| ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| `package.json`, `vitest*.config.*`, `test/setup.ts`, `test/global-setup.ts`, `test/non-isolated-runner.ts`, and test-runner manifest checks | Vitest profile selection, setup/global setup, serial/non-isolated runner behavior, and test wrapper configuration. | Affects which tests run, how tests are isolated, or how fixture/helper behavior shapes test reliability. |

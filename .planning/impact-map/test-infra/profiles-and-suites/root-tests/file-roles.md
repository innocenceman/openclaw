...
| ---------------------------------------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| root `test/*.test.ts` and `test/*.e2e.test.ts` files | Repository-level guardrail, release, boundary, e2e, and configuration tests. | Affects which tests run, how tests are isolated, or how fixture/helper behavior shapes test reliability. |

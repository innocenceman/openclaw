# Extension Test Helpers File Roles
...
| ----------------------------------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `test/helpers/extensions/**`        | Extension/plugin fixture builders and helpers used by extension tests. | Affects which tests run, how tests are isolated, or how fixture/helper behavior shapes test reliability. |

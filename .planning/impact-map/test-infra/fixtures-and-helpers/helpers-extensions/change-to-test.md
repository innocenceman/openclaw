# Extension Test Helpers Change-to-Test
...
- Changed paths: `46` (重命名/移动 31，删除 15).
- Target-existing path refs in active map: `0`; deleted/renamed-away refs kept only in transition artifacts: `46`.

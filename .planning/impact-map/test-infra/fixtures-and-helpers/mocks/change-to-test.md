...
Do not promote to `verified` until fresh scoped or full test output passes; G009 currently records failing mocks and `src/commands/agent.test.ts` reruns.

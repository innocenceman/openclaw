...
Leaf module for `scripts/pre-commit/**`.

## Observed facts

- 2 files observed in `scripts/pre-commit/`.
- Sample files:
...
- Git hooks and CI pre-commit jobs consume this surface.
...
- Changed paths in this leaf: `3` (修改 2，新增 1).

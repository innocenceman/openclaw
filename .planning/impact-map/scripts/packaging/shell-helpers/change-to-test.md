# Scripts shell-helpers Change-to-Test Matrix
...
- Changed paths: `3` (修改 1，重命名/移动 1，删除 1).
- Target-existing path refs in active map: `1`; deleted/renamed-away refs kept only in transition artifacts: `2`.

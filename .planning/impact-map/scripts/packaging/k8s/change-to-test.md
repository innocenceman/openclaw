# Scripts k8s Change-to-Test Matrix
...
| ------------------------------------------ | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Kubernetes deploy/create-kind flow changed | Inspect `scripts/k8s/deploy.sh` or `scripts/k8s/create-kind.sh` usage text first | Escalate to cluster/manual verification only when this task includes live environment work.          |

# Reply Command Registry Families Impact Leaf
...
- Leaf: `command-registry-families/`

## Purpose

Command registry data/runtime wiring, command args, and command-family declarations.
...
- Changed paths in this leaf: `11` (修改 7，新增 4).

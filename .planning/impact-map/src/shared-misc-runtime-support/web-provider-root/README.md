...
- Leaf: `web-provider-root/`

## Purpose

Root web provider/channel-web and bundled web-search registry surfaces.
...
- Changed paths in this leaf: `9` (修改 3，新增 6).

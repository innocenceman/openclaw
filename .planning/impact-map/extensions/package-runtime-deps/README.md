...
- Package/runtime staging surfaces include `scripts/stage-bundled-plugin-runtime-deps.mjs`, `scripts/stage-bundled-plugin-runtime.mjs`, `scripts/lib/bundled-plugin-build-entries.mjs`, `src/plugins/stage-bundled-plugin-runtime.test.ts`, and `test/scripts/stage-bundled-plugin-runtime-deps.test.ts`.

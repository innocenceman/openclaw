# deepgram Other Config or Tool Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/deepgram` or nearest targeted test     | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `12` (修改 7，删除 1，新增 4).
- Target-existing path refs in active map: `11`; deleted/renamed-away refs kept only in transition artifacts: `1`.

# tavily Skill Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/tavily` or nearest targeted test       | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `15` (删除 3，修改 9，新增 3).
- Target-existing path refs in active map: `12`; deleted/renamed-away refs kept only in transition artifacts: `3`.

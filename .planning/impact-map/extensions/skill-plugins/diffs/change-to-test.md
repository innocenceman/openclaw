# diffs Skill Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/diffs` or nearest targeted test        | `pnpm test:extensions` when shared helpers are touched.    |

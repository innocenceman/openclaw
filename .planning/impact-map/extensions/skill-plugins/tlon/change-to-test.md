# tlon Skill Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/tlon` or nearest targeted test         | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `25` (修改 19，新增 6).
- Target-existing path refs in active map: `25`; deleted/renamed-away refs kept only in transition artifacts: `0`.

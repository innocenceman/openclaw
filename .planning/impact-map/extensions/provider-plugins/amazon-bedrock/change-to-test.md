# amazon-bedrock Provider Plugin Change-to-Test Matrix
...
| Provider runtime behavior changed       | `pnpm test -- extensions/amazon-bedrock` or nearest provider test       | `pnpm test:extensions` when shared provider helpers are touched.            |
...
- Changed paths: `17` (新增 11，修改 5，删除 1).
- Target-existing path refs in active map: `16`; deleted/renamed-away refs kept only in transition artifacts: `1`.

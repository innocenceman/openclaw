# kilocode Provider Plugin Change-to-Test Matrix
...
| Provider runtime behavior changed       | `pnpm test -- extensions/kilocode` or nearest provider test             | `pnpm test:extensions` when shared provider helpers are touched.            |
...
- Changed paths: `9` (新增 3，修改 4，重命名/移动 1，删除 1).

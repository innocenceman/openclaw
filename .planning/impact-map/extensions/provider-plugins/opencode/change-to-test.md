# opencode Provider Plugin Change-to-Test Matrix
...
| Provider runtime behavior changed       | `pnpm test -- extensions/opencode` or nearest provider test             | `pnpm test:extensions` when shared provider helpers are touched.            |
...
- Changed paths: `11` (修改 5，新增 5，删除 1).
- Target-existing path refs in active map: `10`; deleted/renamed-away refs kept only in transition artifacts: `1`.

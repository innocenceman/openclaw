# mistral Provider Plugin Change-to-Test Matrix
...
| Provider runtime behavior changed       | `pnpm test -- extensions/mistral` or nearest provider test              | `pnpm test:extensions` when shared provider helpers are touched.            |
...
- Changed paths: `20` (修改 10，重命名/移动 1，新增 7，删除 2).
- Target-existing path refs in active map: `18`; deleted/renamed-away refs kept only in transition artifacts: `2`.

# byteplus Provider Plugin Change-to-Test Matrix
...
| Provider runtime behavior changed       | `pnpm test -- extensions/byteplus` or nearest provider test             | `pnpm test:extensions` when shared provider helpers are touched.            |
...
- Changed paths: `13` (新增 6，修改 5，重命名/移动 1，删除 1).

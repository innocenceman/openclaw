...
Leaf module for provider plugin `extensions/byteplus` with provider id(s) `byteplus`, `byteplus-plan`.
...
- Changed paths in this leaf: `13` (新增 6，修改 5，重命名/移动 1，删除 1).

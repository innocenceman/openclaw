# together Provider Plugin Change-to-Test Matrix
...
| Provider runtime behavior changed       | `pnpm test -- extensions/together` or nearest provider test             | `pnpm test:extensions` when shared provider helpers are touched.            |
...
- Changed paths: `10` (修改 5，新增 4，删除 1).
- Target-existing path refs in active map: `9`; deleted/renamed-away refs kept only in transition artifacts: `1`.

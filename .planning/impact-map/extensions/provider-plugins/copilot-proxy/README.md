...
Leaf module for provider plugin `extensions/copilot-proxy` with provider id(s) `copilot-proxy`.
...
- Changed paths in this leaf: `4` (修改 2，删除 1，新增 1).

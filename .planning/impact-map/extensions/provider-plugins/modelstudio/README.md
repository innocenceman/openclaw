...
Leaf module for provider plugin `extensions/modelstudio` with provider id(s) `modelstudio`.
...
- Changed paths in this leaf: `10` (删除 9，重命名/移动 1).

# exa Other Config or Tool Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/exa` or nearest targeted test          | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `13` (删除 2，修改 5，新增 5，重命名/移动 1).

# brave Other Config or Tool Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/brave` or nearest targeted test        | `pnpm test:extensions` when shared helpers are touched.    |

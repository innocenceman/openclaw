# firecrawl Other Config or Tool Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/firecrawl` or nearest targeted test    | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `19` (新增 7，删除 3，修改 9).
- Target-existing path refs in active map: `16`; deleted/renamed-away refs kept only in transition artifacts: `3`.

# groq Other Config or Tool Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/groq` or nearest targeted test         | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `6` (修改 3，删除 1，新增 2).

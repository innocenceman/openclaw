# perplexity Other Config or Tool Plugin Change-to-Test Matrix
...
| Runtime implementation changed | `pnpm test -- extensions/perplexity` or nearest targeted test   | `pnpm test:extensions` when shared helpers are touched.    |
...
- Changed paths: `13` (删除 3，修改 6，新增 4).
- Target-existing path refs in active map: `10`; deleted/renamed-away refs kept only in transition artifacts: `3`.

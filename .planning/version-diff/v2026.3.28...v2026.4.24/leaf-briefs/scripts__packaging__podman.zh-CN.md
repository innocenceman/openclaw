...
podman 所属的 Build, CI, scripts, tests and release automation 有 2 个路径变化（修改 2），兼容性判断为兼容。
...
- `.planning/version-diff/v2026.3.28...v2026.4.24/leaf-impact.json` 中 leaf `scripts/packaging/podman` 的 mapping。

...
zh cn 所属的 Docs, generated baselines, changelog and public guidance 有 1 个路径变化（修改 1），兼容性判断为仅文档/测试。
...
- 首选验证：Generated zh-CN output changed because English source moved | `pnpm docs:check-i18n-glossary` | Escalate to `scripts/docs-i18n` only when the task explicitly includes regeneration.
...
- `.planning/version-diff/v2026.3.28...v2026.4.24/leaf-impact.json` 中 leaf `docs/mintlify/zh-cn` 的 mapping。

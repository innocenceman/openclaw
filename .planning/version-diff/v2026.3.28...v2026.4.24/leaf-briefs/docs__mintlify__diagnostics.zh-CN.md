...
diagnostics 所属的 Docs, generated baselines, changelog and public guidance 有 1 个路径变化（修改 1），兼容性判断为仅文档/测试。
...
- `.planning/version-diff/v2026.3.28...v2026.4.24/leaf-impact.json` 中 leaf `docs/mintlify/diagnostics` 的 mapping。

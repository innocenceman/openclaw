...
huggingface 所属的 Model/search/provider plugins and tool surfaces 有 9 个路径变化（新增 2、修改 5、删除 1、重命名 1），兼容性判断为行为变化。
...
- `.planning/version-diff/v2026.3.28...v2026.4.24/leaf-impact.json` 中 leaf `extensions/provider-plugins/huggingface` 的 mapping。

...
| ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | -------------- | ----------------------------------------------------------------------- |
| docs/.generated/plugin-sdk-api-baseline.json and docs/.generated/plugin-sdk-api-baseline.jsonl | Checked-in Plugin SDK API baselines.                          | deep-partial   | These guard the public SDK surface against silent drift.                |

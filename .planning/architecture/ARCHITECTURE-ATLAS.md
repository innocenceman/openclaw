...
> Target baseline: this atlas is carried forward for `v2026.3.28` planning refresh. Version-diff facts live in `.planning/version-diff/v2026.3.24...v2026.3.28/`; stale deleted-source references are archived under that transition directory.

...
> Target baseline: this atlas is carried forward for `v2026.4.24` planning refresh. Version-diff facts live in `.planning/version-diff/v2026.3.28...v2026.4.24/`; stale deleted-source references are archived under that transition directory.
